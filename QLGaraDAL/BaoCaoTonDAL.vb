...
Public Class BaoCaoTonDAL
    ...
    Public Function insert(vattuphutung As HieuXeDTO) As Result

        Dim f = False
        Dim result = select_Check(VATTUPHUTUNG, f)
        If (result.FlagResult = False) Then
            Return result
        End If
        If (f = True) Then ' existed on DB
            Return Me.update(VATTUPHUTUNG)
        End If
